        ...
        <div className="container mx-auto px-4 py-10 md:py-20 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="font-body text-xl md:text-2xl text-foreground-alt max-w-3xl mx-auto leading-relaxed">
              Automatiza llamadas y mensajes con un agente entrenado en el
              lenguaje real de la industria veterinaria.
            </p>

            {/* Reproductor de Audio */}
            <div>
              <AudioPlayer src="https://api.foneia.com/media/resources/calls/call_example.mp3" />
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="font-heading text-4xl md:text-5xl font-black text-white">
              ¿Tu recepción está{" "}
              <span className="text-secondary">colapsada</span>?
            </h2>

            <p className="font-body text-xl text-foreground-muted max-w-3xl mx-auto leading-relaxed">
              Llamadas sin responder, mensajes acumulándose, tiempos de espera
              eternos, clientes impacientes... y cuando logras atender, tienes
              que escalar información a médicos, farmacia, caja. El caos diario
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-8 mb-16">
              <h2 className="font-heading text-4xl md:text-5xl font-black text-white">
                ...
                <span className="gradient-text">lenguaje de la industria</span>
              </h2>

              <p className="font-body text-xl text-foreground-muted max-w-3xl mx-auto leading-relaxed">
                Nuestra solución gestiona automáticamente mensajes y llamadas,
                resuelve dudas, escala internamente cuando es necesario, y
                responde 24/7 con el conocimiento específico del sector
                veterinario.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <Card className="glass text-white shadow-xl hover-lift border-white/10">
                <CardContent className="p-8">
                  ...
                  <p className="text-white/90 mb-6">
                    Conversación fluida, personalizada y rápida. Resuelve
                    consultas sobre servicios, precios, disponibilidad y agenda
                    citas de forma natural.
                  </p>
              ...
              <Card className="glass text-white shadow-xl hover-lift border-white/10">
                <CardContent className="p-8">
                  ...
                  <p className="text-white/90 mb-6">
                    Atiende llamadas como un asistente real y dispara flujos
                    posteriores por WhatsApp para dar seguimiento personalizado.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-5 w-5 text-white/80" />
              ...
              <Card className="glass text-white shadow-xl hover-lift border-white/10">
                <CardContent className="p-8">
                  ...
                  <p className="text-white/90 mb-6">
                    <strong>Nuestro diferencial:</strong> una sola IA que cubre
                    todo el proceso, no bots aislados por canal. Atiende, escala
                    y resuelve sin descoordinación.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-5 w-5 text-white/80" />
      ...
      <section id="sectores" className="bg-background-alt py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="font-heading text-4xl md:text-5xl font-black text-white">
              ¿Por qué un{" "}
              <span className="text-secondary">agente genérico</span> no es
              suficiente?
            </h2>

            <p className="font-body text-xl text-foreground-muted max-w-3xl mx-auto leading-relaxed">
              Los bots genéricos no entienden la terminología veterinaria,
              alucinan respuestas y no escalan internamente. Nosotros entrenamos
              con la data real de las marcas del sector.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 pt-12">
              ...
              <Card className="glass border-white/10 shadow-lg hover-lift">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="font-body text-foreground-muted text-sm">
                    Se integra con tu proceso actual sin modificaciones
                    complejas
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="glass border-white/10 shadow-lg hover-lift">
                <CardContent className="p-6 rounded-xl">
                  ...
                  <p className="font-body text-foreground-muted mb-4">
                    "Nuestro equipo puede enfocarse en lo médico mientras el
                    agente maneja las consultas básicas perfectamente."
                  </p>
              ...
              <Card className="glass border-white/10 shadow-lg hover-lift">
                <CardContent className="p-6 rounded-xl">
                  <div className="text-secondary text-4xl mb-4 font-bold">
                    "
                  </div>
                  <p className="font-body text-foreground-muted mb-4">
                    "Las ventas aumentaron 40% al no perder ninguna consulta.
              ...
              <Card className="glass border-white/10 shadow-lg hover-lift">
                <CardContent className="p-6 rounded-xl">
                  <div className="text-primary text-4xl mb-4 font-bold">"</div>
                  <p className="font-body text-foreground-muted mb-4">
                    "La diferencia es increíble. Habla como nosotros, conoce
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="font-body text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Activa tu agente inteligente y mejora tu atención, tus ventas y la
              percepción de tu clínica. Sin complicaciones técnicas, sin cambios
              drásticos en tu operación.
            </p>
            <div className="pt-8">
              <Button
                size="lg"
                className="px-12 py-4 text-lg font-semibold bg-gradient-primary hover:opacity-90 transition-opacity"
                onClick={() =>
                  window.open(
            ...
            <div className="space-y-6" style={{ marginTop: "-10px" }}>
              <div>
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  Construimos ecosistemas inteligentes que combinan IA
                  especializada, software a medida e infraestructura
                  interoperable para resolver problemas reales de negocio.
                </p>
              </div>
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.linkedin.com/company/somoshubu/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/hubu.io/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-integration rounded-full flex items-center justify-center hover:bg-integration/80 transition-colors"
                >
                  <svg
                    className="w-5 h-5 text-white"
                    fill="currentColor"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-integration/20 rounded flex items-center justify-center">
                    <svg
                      className="w-4 h-4 text-integration"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">
                      Únete a nuestra comunidad técnica
                    </p>
                  </div>
                </div>
                <Button
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">
                      Insights sobre IA y desarrollo
                    </p>
                  </div>
                </div>
                <Button
